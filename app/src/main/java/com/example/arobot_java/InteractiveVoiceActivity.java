...
package com.example.arobot_java;
...
public class InteractiveVoiceActivity extends Activity
    ...
    private void init() {
        ...
        voiceView.setInteractiveVoiceListener(
                new InteractiveVoiceView.InteractiveVoiceListener() {
                    ...
                    public void onResponse(Response response) {
                        ...
                        Log.d(LOG_TAG, "Transcript: " + response.getInputTranscript());
        ...
        InteractionConfig lexInteractionConfig = new InteractionConfig("prototype","Prod");
        //lexInteractionConfig.setNoSpeechTimeoutInterval();
        ...
        AWSMobileClient.getInstance().initialize(this, new Callback<UserStateDetails>() {
            ...
            public void onResult(UserStateDetails result) {
                ...
                voiceView.getViewAdapter()
                        .setInteractionConfig(
                                new InteractionConfig("prototype","Prod"));
    ...
    public void onResponse(Response response) {
        ...
        Log.d(TAG, "Transcript: " + response.getSessionAttributes());
        responseTextView.setText(response.getTextResponse());
        transcriptTextView.setText(response.getInputTranscript());
    }
